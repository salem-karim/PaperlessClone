...
import at.technikum.restapi.service.OcrResponseDto;
...
public class DocumentResponseListener {
    ...
    public void handleOcrResponse(OcrResponseDto response) {
        ...
        if ("completed".equals(response.getStatus())) {
            ...
            // documentService.updateOcrText(UUID.fromString(response.getDocument_id()), ocrText);
            ...
            // documentService.markAsFailed(UUID.fromString(response.getDocument_id()), response.getError());
        }
    }
}
